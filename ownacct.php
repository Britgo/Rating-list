...
if (mysql_num_rows($ret) == 0)  {
    $Title = "Unknown user";
    $mess = "$userid is an unknown user (huh?)";
    include 'php/generror.php';
    exit(0); 
}
...
$pw = $row['password'];
$em = $row['email'];
$hquserid = htmlspecialchars($userid);
...
<p>Please use the form below to update your account on the rating list database.</p>
<form name="trform" action="ownacct2.php" method="post" enctype="application/x-www-form-urlencoded" onsubmit="javascript:return formvalid();">
